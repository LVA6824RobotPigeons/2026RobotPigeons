...
public class RobotContainer {
    ...
    private final double steerSensitivity = 0.80; // Multipler
    private final double driveSensitivity = 0.80; // Multiplier
    ...
    private final SubsystemCommands subsystemCommands = new SubsystemCommands(
        ...
        hood,
        hanger,
        () -> -driver.getLeftY()*driveSensitivity,
        () -> -driver.getLeftX()*driveSensitivity
    );
    ...
    private void configureManualDriveBindings() {
        final ManualDriveCommand manualDriveCommand = new ManualDriveCommand(
            ...
            () -> -driver.getLeftY()*driveSensitivity, 
            () -> -driver.getLeftX()*driveSensitivity, 
            () -> -driver.getRightX()*steerSensitivity
        );
